    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="/location" method="GET" class="row g-3">
                ...
                <div class="col-md-2">
                    <label for="price_min" class="form-label">Loyer min</label>
                    <input type="number" class="form-control" id="price_min" name="price_min" value="<?= $_GET['price_min'] ?? '' ?>">
                </div>
                
                <div class="col-md-2">
                    <label for="price_max" class="form-label">Loyer max</label>
                ...
                <div class="col-12">
                    ...
                    <a href="/location" class="btn btn-secondary">Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <strong><?= number_format($annonce['price'], 0, ',', ' ') ?> € / mois</strong>
                                <?php if ($annonce['charges'] > 0): ?>
                                    <br><small>Charges : <?= number_format($annonce['charges'], 0, ',', ' ') ?> € / mois</small>
                                <?php endif; ?>
                                <br><?= htmlspecialchars($annonce['city']) ?>
                                <br><?= $annonce['surface'] ?> m² - <?= $annonce['pieces'] ?> pièces
                            </p>
